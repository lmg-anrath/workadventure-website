...
const stickCanvasAtCenter = () => {
  ...
  if (
    scrollY + window.innerHeight / 2 >= containerTop + canvasHeight / 2 &&
    scrollY <
      containerHeight + containerTop - window.innerHeight / 2 - canvasHeight / 2
  ) {
    ...
    scrollY >
    containerTop + containerHeight - window.innerHeight / 2 - canvasHeight / 2
  ) {
...
onMounted(() => {
  ...
  window.addEventListener("scroll", () => {
    ...
    const maxScrollTop =
      container.value.offsetHeight - canvas.value.offsetHeight;
